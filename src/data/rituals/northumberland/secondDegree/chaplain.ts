...
export const CHAPLAIN_RITUALS: RitualSection[] = [
  {
    ...
    content: [
      "Chaplain: Let us supplicate the GGOTU, that the rays of Heaven may shed their benign influence over us, to enlighten us in the paths of nature and science."
    ]
  }
];
