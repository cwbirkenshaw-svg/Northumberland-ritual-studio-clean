...
export const TYLER_RITUALS: RitualSection[] = [
  {
    ...
    office: Office.TYLER,
    title: 'Tyler: At the Door',
    content: [
      'T. Brother ---------- ... comes properly prepared.',
      'T. By the help of the Most High, the united aid of the Square and compasses, and the benefit of a Pass Grip and Password'
    ]
  }
];
